...
/**
 * @method Specs getAttributes() Get the attributes for the input field
 * @method Specs setAttributes(array $attributes) Set attributes for the input field
 * @method Specs setAttribute($attr, $value = null) Set/Unset attribute for the input field
 * @method Specs addClass($class) Add a CSS class  for the input field
 * @method Specs removeClass($class) Removes a CSS class for the input field
 * @method Specs toggleClass($class) Toggles a class  for the input field
 */
