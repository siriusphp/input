...
class FormTest extends \PHPUnit_Framework_TestCase
{
    ...
    function testPopulate()
    {
        ...
        $this->assertEquals('This field is required', (string)$this->form->getValidator()->getMessages('email')[0]);
    }
    ...
    function testSuccessfulUpload()
    {
        ...
        $mockedUploadHandler->shouldReceive('process')
            ->andReturn(new \Sirius\Upload\Result\File($file, $mockedUploadContainer));
